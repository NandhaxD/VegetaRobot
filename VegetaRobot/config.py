...
class Config(object):
    ...
    OWNER_ID = 5781844850  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    ...
    JOIN_LOGGER = 7179142363  #Prints any new group the bot is added to, prints just the name and ID.
    REM_BG_API_KEY = "dxsh728mZMDmj4ijSZCNPZig"
    EVENT_LOGS = 7179142363  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
    LOAD = []
