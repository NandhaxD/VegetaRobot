...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a Developer of Miku"
        nation_level_present = True
    elif user.id in DRAGONS:
        text += f"\n\nThe Nation level of this person is Royal"
        nation_level_present = True
    elif user.id in DEMONS:
        text += f"\n\nThe Nation level of this person is Wolves"
        nation_level_present = True
    elif user.id in TIGERS:
        text += f"\n\nThe Nation level of this person is Tigers"
        nation_level_present = True
    elif user.id in WOLVES:
        text += f"\n\nThe Nation level of this person is Demons"
        nation_level_present = True
