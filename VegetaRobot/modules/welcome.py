...
WELC_PREF_HANDLER = CommandHandler("welcome", welcome, filters=Filters.ChatType.GROUP, run_async=True)
GOODBYE_PREF_HANDLER = CommandHandler("goodbye", goodbye, filters=Filters.ChatType.GROUP, run_async=True)
SET_WELCOME = CommandHandler("setwelcome", set_welcome, filters=Filters.ChatType.GROUP, run_async=True)
SET_GOODBYE = CommandHandler("setgoodbye", set_goodbye, filters=Filters.ChatType.GROUP, run_async=True)
RESET_WELCOME = CommandHandler(
    "resetwelcome", reset_welcome, filters=Filters.ChatType.GROUP, run_async=True)
RESET_GOODBYE = CommandHandler(
    "resetgoodbye", reset_goodbye, filters=Filters.ChatType.GROUP, run_async=True)
WELCOMEMUTE_HANDLER = CommandHandler(
    "welcomemute", welcomemute, filters=Filters.ChatType.GROUP, run_async=True)
CLEAN_SERVICE_HANDLER = CommandHandler(
    "cleanservice", cleanservice, filters=Filters.ChatType.GROUP, run_async=True)
CLEAN_WELCOME = CommandHandler(
    "cleanwelcome", clean_welcome, filters=Filters.ChatType.GROUP, run_async=True)
