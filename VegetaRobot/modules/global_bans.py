...
from VegetaRobot.modules.helper_funcs.extraction import (
    extract_user,
...
GBAN_STATUS = CommandHandler("antispam", gbanstat, filters=Filters.ChatType.GROUP, run_async=True)

GBAN_ENFORCER = MessageHandler(Filters.all & Filters.ChatType.GROUP, enforce_gban)
