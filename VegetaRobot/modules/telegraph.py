    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                vegetabutton = [[Button.url("T-GRAPH Link 📤", f"https://telegra.ph/{media_urls[0]}")]]
                os.remove(downloaded_file_name)
                await h.edit("Link Preview[!](https://telegra.ph{})".format(media_urls[0]), link_perview=True, buttons=vegetabutton)
        elif input_str == "xt":
