    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                vegeta = [[Button.url("Telegraph ✨", f"http://graph.org{media_urls[0]}")]]
                os.remove(downloaded_file_name)
                await h.edit("https://graph.org{}".format(media_urls[0]), link_preview=True, buttons=vegeta)
        elif input_str == "xt":
