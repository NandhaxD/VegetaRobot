...
def info(update: Update, context: CallbackContext):
    ...
    text += f"\nᴘᴇʀᴍᴀʟɪɴᴋ: {mention_html(user.id, 'link')}"

    if chat.type != "ᴘʀɪᴠᴀᴛᴇ" and user_id != bot.id:
        _stext = "\nᴘʀᴇsᴇɴᴄᴇ: <code>{}</code>"
    ...
    try:
        ...
        if spamwtc:
            ...
            text += f"\nGbanned Reason: <pre>{spamwtc.reason}</pre>"
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Ranking of The Person is Owner of Vegeta"
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis Person is a Developer of Vegeta"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThis Person is a S-Rank of Vegeta"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis Person is a B-Rank User of Vegeta"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis Person is C-Rank of vegeta"
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nThis person is D-Rank of Vegeta"
        disaster_level_present = True
...
*Overall Information about you:*
 •`/myinfo`*:* get information about you.
 • `/info`*:* get information about a user. 

 
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/pigasusoffcial)
"""
