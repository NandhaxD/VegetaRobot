...
NO_AFK_HANDLER = MessageHandler(Filters.all & Filters.ChatType.GROUP, no_longer_afk,run_async=True)
AFK_REPLY_HANDLER = MessageHandler(Filters.all & Filters.ChatType.GROUP, reply_afk,run_async=True)
