...
#from VegetaRobot import kp as pbot
from VegetaRobot.events import register as yuii


Credit = "This Plugin Made by Yoga (@Yoga_CIC), if you're using this code in your bot. there is no issue but don't remove this line" 


#@yuii.on_message(filters.command("mmf"))
@yuii(pattern="^/mmf ?(.*)")
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./VegetaRobot/resources/ArmWrestler.ttf"
