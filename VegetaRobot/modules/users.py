...
USER_HANDLER = MessageHandler(Filters.all & Filters.ChatType.GROUP, log_user, run_async=True)
CHAT_CHECKER_HANDLER = MessageHandler(Filters.all & Filters.ChatType.GROUP, chat_checker, run_async=True)
