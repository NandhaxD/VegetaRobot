...
from VegetaRobot import BOT_USERNAME, OWNER_ID, pgram, arq
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Scorbunnyrobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
    
    msg = f"""
**[VegetaRobot](https://telegra.ph/file/394f28c5cc0f0d4db0dd7.jpg):**
**🌟MᴀɪɴBᴏᴛ:** `{bot_state}`
**🤖UsᴇʀBᴏᴛ:** `Aʟɪᴠᴇ`
**🐍Pʏᴛʜᴏɴ:** `3.9`
**📊Pʏʀᴏɢʀᴀᴍ:** `{pyrover}`
**🍏MᴏɴɢᴏDB:** `{mongover}`
**🛤️Pʟᴀᴛғᴏʀᴍ:** `{sys.platform}`
