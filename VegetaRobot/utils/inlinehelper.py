...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        ...
        InlineKeyboardButton("Get More Help.", url=f"t.me/VegetaRobot?start=start"),
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/db5cded7dec5e7fad0dae.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        ...
        InlineKeyboardButton("Main Bot", url="https://t.me/VegetaRobot"),
...
**Profiles:** [BOT](t.me/VegetaRobot) | [My Owner](https://t.me/Ctzfamily)
